...
WHERE ac.school_year = '2011-2012'
  ...
  AND disability_flag IS NULL
GROUP BY hs.sch_name, hs.hs_completion_num, hs.sch_name, ac.sch_accred, hs_completion_name;
